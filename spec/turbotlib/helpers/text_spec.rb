...
require 'turbotlib/helpers/text'

describe TurbotLib::Helpers::Text do
  describe "#normalise_utf8_spaces" do
    it "should convert UTF-8 spaces to normal spaces" do
      ...
      raw_and_normalised_text.each do |raw_text, normalised_text|
        TurbotLib::Helpers::Text.normalise_utf8_spaces(raw_text).should == normalised_text
      end
    end
  end
